...
var first_question = 'What shape is an apple?'
var second_question = 'What shape is the sun?'
var third_question = 'What shape is a pyramid?'
var fourth_question = 'What shape is a ball?'
var fifth_question = 'What shape is a door?'
...
a1.innerText = 'Circle'
a2.innerText = 'Square'
a3.innerText = 'Triangle'
a4 .innerText= 'Rectangle'
}else if(count == 2){
    a1.innerText = 'Triangle'
    a2.innerText = 'Square'
    a3.innerText = 'Circle'
    a4.innerText = 'Rectangle'
}else if(count == 3){
    ...
    a1.innerText = 'Rectangle'
    a2.innerText = 'Square'
    a3.innerText = 'Circle'
    a4.innerText = 'Triangle'
}
else if(count == 5){
    a1.innerText = 'Circle'
    a2.innerText = 'Rectangle'
    a3.innerText = 'Triangle'
    a4.innerText = 'Square'
}
...
function checkingAnswer(){
    ...
    else if(count == 4 && choice == 3){
        result.style.backgroundColor = 'green'
        result_text.innerText = right
        ++score
    }
    else if(count == 5 && choice == 2){
        result.style.backgroundColor = 'green'
        result_text.innerText = right
        ++score
    }else{
